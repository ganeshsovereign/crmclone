...
MetronicApp.config(function($stateProvider, $urlRouterProvider) {
    ...
    $stateProvider.state('settings', {
        ...
        .state('settings.module', {
            url: '/module',
            abstract: true,
            templateUrl: '/views/settings/modules/index.html',
        })
        .state('settings.module.list', {
            url: "",
            templateUrl: "/views/settings/modules/list.html",
            data: {
                pageTitle: 'Configuration des modules'
            },
            controller: 'SettingModuleController'
        })
        .state('settings.module.show', {
            url: "/{id}",
            templateUrl: "/views/settings/modules/fiche.html",
            data: {
                pageTitle: 'Configuration du module Commandes'
            },
            controller: 'SettingModuleController'
        });
});
...
MetronicApp.factory("Settings", ['$resource', function($resource) {
    return {
        ...
        module: $resource('/erp/api/module/:Id', {
            Id: '@_id'
        }, {
            query: {
                method: 'GET',
