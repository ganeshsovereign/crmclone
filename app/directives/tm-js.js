...
MetronicApp.directive(
    ...
    function(dateFilter) {
        return {
            ...
            template: '<p class="input-group"><input type="text" class="form-control" placeholder="jj/mm/aaaa" ng-model="dt" min-date="minDate" init-date="null" datepicker-popup="dd/MM/yyyy" is-open="opened" datepicker-options="dateOptions" ng-required="false" close-text="Fermer" /><span class="input-group-btn"><button type="button" class="btn btn-default" ng-click="open($event)"><i class="glyphicon glyphicon-calendar"></i></button></span></p>',
            replace: true,
