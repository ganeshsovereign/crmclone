...
MetronicApp.controller('ContactController', ['$scope', '$rootScope', '$http', '$filter', 'Contacts', 'Societes', function ($scope, $rootScope, $http, $filter, Contacts, Societes) {
        ...
        $scope.createLogin = function (contact) {
            ...
            $http({method: 'POST', url: '/erp/api/contact/login/'+contact._id
            }).success(function (data, status) {
                if (status == 200)
                    $scope.contact = data;
            });
...
MetronicApp.controller('ContactCreateController', ['$scope', '$rootScope', '$http', '$modalInstance', 'Contacts', 'object', function ($scope, $rootScope, $http, $modalInstance, Contacts, object) {
