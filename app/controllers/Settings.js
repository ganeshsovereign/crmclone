...
angular.module("MetronicApp").controller('SettingCategoryController', ['$scope', '$rootScope', '$http', '$timeout', '$modal', 'toastr', 'Categories', function($scope, $rootScope, $http, $timeout, $modal, toastr, Categories) {
    $scope.categories = [];
    $scope.category = {
        enabled: true
    };
