...
\begin{tabular}{p{9cm} p{8cm}}
   ...
   \raggedleft
	%\begin{flushright}
	\textcolor{violet}{\textsc{\Large Bon de retour --NUM--}}\\
...
{\small Emetteur :}\\
\begin{fminipage}
\textbf{\large --BILL.NAME--}\\
--BILL.ADDRESS--\\
\textsc{--BILL.ZIP-- --BILL.TOWN--}\\
...
{\it Date de retour : \textbf{--DATEEXP--}}
\vspace{1em}
\end{flushright}
\end{minipage}
...
\multicolumn{1}{c}{D\'esignation} &
\multicolumn{1}{c}{Qté cmdée} &
\multicolumn{1}{c|}{Qté retournée} \\ \hline \hline
\endhead
