    ...
    function maskScope(actionObj, maskset, opts) {
        ...
        function stripValidPositions(start, end) {
            ...
            for (i = end; i <= getLastValidPosition();) {
                var t = getMaskSet().validPositions[i],
                    s = getMaskSet().validPositions[startPos];
        ...
        function getTestTemplate(pos, ndxIntlzr, tstPs) {
            function checkAlternationMatch(test, altNdx, altArr) {
                for (var altArrC = opts.greedy ? altArr : altArr.slice(0, 1), isMatch = !1, altLocArr = test.locator[altNdx].toString().split(","), alndx = 0; alndx < altLocArr.length; alndx++)
                    if (-1 != $.inArray(altLocArr[alndx], altArrC)) {
                        isMatch = !0;
                        break;
                    }
                return isMatch;
            }
            for (var testPos, testPositions = getTests(pos, ndxIntlzr, tstPs), lvp = getLastValidPosition(), lvTest = getMaskSet().validPositions[lvp] || getTests(0)[0], lvTestAltArr = void 0 != lvTest.alternation ? lvTest.locator[lvTest.alternation].split(",") : [], ndx = 0; ndx < testPositions.length && (testPos = testPositions[ndx], !(opts.greedy || testPos.match && (testPos.match.optionality === !1 || testPos.match.newBlockMarker === !1) && testPos.match.optionalQuantifier !== !0 && (void 0 == lvTest.alternation || void 0 != testPos.locator[lvTest.alternation] && checkAlternationMatch(testPos, lvTest.alternation, lvTestAltArr)))); ndx++);
            return testPos;
        }
        ...
        function getTests(pos, ndxIntlzr, tstPs) {
                    ...
                    if (void 0 != match.matches) {
                        if (match.isGroup && quantifierRecurse !== !0) {
                            ...
                            if (-1 == altIndex || "string" == typeof altIndex) {
                                var altIndexArr, currentPos = testPos,
                                ...
                                for (var amndx = 0; amndx < alternateToken.matches.length; amndx++) {
                                    ...
                                    for (var ndx1 = 0; ndx1 < maltMatches.length; ndx1++)
                                        for (var altMatch = maltMatches[ndx1], ndx2 = 0; ndx2 < malternateMatches.length; ndx2++) {
            ...
            if (void 0 == ndxIntlzr) {
                ...
                if (void 0 != test && previousPos > -1) testPos = previousPos, ndxInitializer = test.locator.slice();
                else {
        ...
        function refreshFromBuffer(start, end) {
            ...
            if (start === !0) resetMaskSet(), start = 0, end = buffer.length;
                ...
                for (var i = start; end > i; i++) delete getMaskSet().validPositions[i],
        ...
        function isValid(pos, c, strict, fromSetValid) {
                    ...
                    if (c && (chrs += c), rslt = null != test.fn ? test.fn.test(chrs, getMaskSet(), position, strict, opts) : c != test.def && c != opts.skipOptionalPartCharacter || "" == test.def ? !1 : {
                        ...
                        if (void 0 != rslt.remove && stripValidPositions(rslt.remove, rslt.remove + 1),
                            ...
                            if (validatedPos = void 0 != rslt.pos ? rslt.pos : position, validatedPos != position) return rslt = $.extend(rslt, isValid(validatedPos, elem, !0)), !1;
                                ...
                                refreshFromBuffer(position, validatedPos), validatedPos != position)) return rslt = $.extend(rslt, isValid(validatedPos, elem, !0)), !1;
            ...
            function alternate(pos, c, strict, fromSetValid) {
                ...
                for (lastAlt = getLastValidPosition(); lastAlt >= 0; lastAlt--)
                    if (getMaskSet().validPositions[lastAlt] && void 0 != getMaskSet().validPositions[lastAlt].alternation) {
                        alternation = getMaskSet().validPositions[lastAlt].alternation;
                        break;
                    }
                if (void 0 != alternation)
                    for (var decisionPos in getMaskSet().validPositions)
                        if (parseInt(decisionPos) > parseInt(lastAlt) && void 0 === getMaskSet().validPositions[decisionPos].alternation) {
                            for (var altPos = getMaskSet().validPositions[decisionPos], decisionTaker = altPos.locator[alternation], altNdxs = getMaskSet().validPositions[lastAlt].locator[alternation].split(","), mndx = 0; mndx < altNdxs.length; mndx++)
                                if (decisionTaker < altNdxs[mndx]) {
                                    for (var possibilityPos, possibilities, dp = decisionPos - 1; dp >= 0; dp--)
            ...
            function trackbackAlternations(originalPos, newPos) {
                for (var vp = getMaskSet().validPositions[newPos], targetLocator = vp.locator, tll = targetLocator.length, ps = originalPos; newPos > ps; ps++)
                    if (!isMask(ps)) {
                        var bestMatch, tests = getTests(ps),
                            equality = -1;
                        for (var tndx in tests)
                            for (var activeTest = tests[tndx], i = 0; tll > i; i++) targetLocator[i] == activeTest.locator[i] && i > equality && (equality = i,
            ...
            var maskPos = pos,
                result = !1;
            if (fromSetValid && maskPos >= getMaskLength() && resetMaskSet(!0), maskPos < getMaskLength() && (result = _isValid(maskPos, c, strict, fromSetValid), !strict && result === !1)) {
        ...
        function clearOptionalTail(input) {
            ...
            if ($.isFunction(opts.postProcessOnBlur)) opts.postProcessOnBlur.call(input, tmpBuffer, opts);
            else {
        ...
        function handleRemove(input, k, pos) {
            function generalize() {
                if (opts.keepStatic) {
                    ...
                    if (lastAlt > 0)
                        for (; validInputs.length > 0;) getMaskSet().p = seekNext(getLastValidPosition()),
        ...
        function keydownEvent(e) {
            ...
            var currentCaretPos = caret(input),
                keydownResult = opts.onKeyDown.call(this, e, getBuffer(), currentCaretPos.begin, opts);
            ...
            if (k) {
                ...
                if (valResult !== !1) {
                    if (valResult !== !0 && (p = void 0 != valResult.pos ? valResult.pos : p, c = void 0 != valResult.c ? valResult.c : c),
                        resetMaskSet(!0), void 0 != valResult.caret) forwardPosition = valResult.caret;
                    else {
                        var vps = getMaskSet().validPositions;
                ...
                if (opts.showTooltip && $input.prop("title", getMaskSet().mask), e && 1 != checkval) {
                    e.preventDefault();
                    var currentCaretPos = caret(input),
                        keypressResult = opts.onKeyPress.call(this, e, getBuffer(), currentCaretPos.begin, opts);
        ...
        function keyupEvent(e) {
            var $input = $(this),
                ...
                k = e.keyCode,
                buffer = getBuffer(),
                currentCaretPos = caret(input),
                keyupResult = opts.onKeyUp.call(this, e, buffer, currentCaretPos.begin, opts);
                ...
                $el.unbind(".inputmask"), $el.closest("form").bind("submit", function() {
                        ...
                        if ($input.is(":focus")) {
                            ...
                            if (selectedCaret.begin == selectedCaret.end)
                                if (opts.radixFocus && "" != opts.radixPoint && -1 != $.inArray(opts.radixPoint, getBuffer()) && (firstClick || getBuffer().join("") == getBufferTemplate().join(""))) caret(input, $.inArray(opts.radixPoint, getBuffer())),
                                    firstClick = !1;
                                else {
        ...
        var valueOnFocus, $el, maxLength, isRTL = !1,
            skipKeyPressEvent = !1,
            skipInputEvent = !1,
            ignorable = !1,
            firstClick = !0;
    ...
    return $.extend($.inputmask.defaults.aliases, {
        numeric: {
            ...
            leadingZeroHandler: function(chrs, maskset, pos, strict, opts) {
                ...
                if (matchRslt && !strict && (-1 == radixPosition || matchRslt.index < radixPosition))
                    if ("0" == matchRslt[0] && pos >= opts.prefix.length) {
            ...
            definitions: {
                "~": {
                    validator: function(chrs, maskset, pos, strict, opts) {
                        ...
                        if (!isValid && (isValid = opts.radixHandler(chrs, maskset, pos, strict, opts), !isValid && (isValid = strict ? new RegExp("[0-9" + $.inputmask.escapeRegex.call(this, opts.groupSeparator) + "]").test(chrs) : new RegExp("[0-9]").test(chrs),
                    ...
                    validator: function(chrs, maskset, pos, strict, opts) {
                        ...
                        function validateRegexToken(token, fromGroup) {
                            ...
                            for (var mndx = 0; mndx < token.matches.length; mndx++) {
                                ...
                                if (1 == matchToken.isGroup) isvalid = validateRegexToken(matchToken, !0);
