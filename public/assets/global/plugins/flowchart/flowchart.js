...
(function() {
    ...
    function drawPath(chart, location, points) {
        ...
        if (fontF) symbol.attr({
            'font-family': fontF
        });
        if (fontW) symbol.attr({
            'font-weight': fontW
        });
    ...
    function drawLine(chart, from, to, text) {
        ...
        if (text) {
            ...
            if (font) textPath.attr({
                'font': font
            });
            if (fontF) textPath.attr({
                'font-family': fontF
            });
            if (fontW) textPath.attr({
                'font-weight': fontW
            });
        }
    ...
    function Symbol(chart, options, symbol) {
        ...
        if (font) this.text.attr({
            'font': font
        });
        if (fontF) this.text.attr({
            'font-family': fontF
        });
        if (fontW) this.text.attr({
            'font-weight': fontW
        });
    ...
    function Subroutine(chart, options) {
        ...
        if (font) innerWrap.attr({
            'font': font
        });
        if (fontF) innerWrap.attr({
            'font-family': fontF
        });
        if (fontW) innerWrap.attr({
            'font-weight': fontW
        });
