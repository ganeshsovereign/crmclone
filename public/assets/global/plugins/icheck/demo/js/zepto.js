...
var Zepto = function() {
    ...
    n.init = function(a, b) {
        if (a) {
            ...
            else if (q(a)) d = [k(a) ? c.extend({}, a) : a], a = null;
            else if (N.test(a)) d = n.fragment(a.trim(), RegExp.$1, b), a = null;
            else {
    ...
    c.map = function(a, b) {
        var d, e = [],
            f;
        if (l(a))
            for (f = 0; f < a.length; f++) d = b(a[f], f), null != d && e.push(d);
        else
            for (f in a) d = b(a[f], f), null != d && e.push(d);
    ...
    c.fn = {
        ...
        css: function(a,
            ...
            if ("string" == h(a)) !b && 0 !== b ? this.each(function() {
                ...
                for (g in a) !a[g] && 0 !== a[g] ? this.each(function() {
...
(function(h) {
    ...
    h.Event = function(e, f) {
        ...
        var g = document.createEvent(A[e] || "Events"),
            c = !0;
        if (f)
            for (var h in f) "bubbles" == h ? c = !!f[h] : g[h] = f[h];
