(function() {
    ...
    e.AmMap = e.Class({
        ...
        initChart: function() {
            ...
            } else(e.AmMap.base.initChart.call(this), e.hasSVG) ? (this.dataChanged && (this.parseData(), this.dispatchDataUpdated = !0, this.dataChanged = !1, a = this.legend) && (a.position = "absolute", a.invalidateSize()), this.createDescriptionsDiv(), this.svgAreas = [], this.svgAreasById = {}, this.drawChart()) : (this.chartDiv.style.textAlign = "", this.chartDiv.setAttribute("class",
        ...
        handleMouseMove: function(a) {
            ...
            if (!a || !a.touches || !b.tapToActivate || b.tapped) {
                ...
                if (a =
                    ...
                    if (!isNaN(h)) {
                        b.stopDrag();
                        var q = Math.sqrt(Math.pow(h - f, 2) + Math.pow(k - l, 2)),
                            p = b.initialDistance;
                        ...
                        if (!isNaN(p)) {
                            ...
                            .1 < Math.abs(h - g) && (b.zoomTo(h, p, k, !0), b.mapWasPinched = !0, clearTimeout(b.pinchTO))
                        }
                    }
                    h = a.scale;
                    b.isDragging && (b.balloon.hide(0), b.positionChanged(), c = a.x + (f - c), d = a.y + (l - d), b.preventDragOut && (u = -u * h + n / 2, n /= 2, c = e.fitToBounds(c, -r * h + m / 2, m / 2), d = e.fitToBounds(d, u, n)), a.translate(c, d, h, !0), b.updateSmallMap());
                    b.previuosMouseX = f;
                    b.previuosMouseY =
                        l
                }
        ...
        selectObject: function(a, b) {
            ...
            var l = !1,
                g, h;
            "MapArea" == a.objectType && (a.autoZoomReal && (l = !0), g = c.areasSettings.selectedOutlineColor, h = c.areasSettings.selectedOutlineThickness);
            if (d && !l && ("string" == typeof d && (d = c.getObjectById(d)), isNaN(a.zoomLevel) && isNaN(a.zoomX) && isNaN(a.zoomY))) {
            ...
            d = c.zoomDuration;
            !l && isNaN(a.zoomLevel) && isNaN(a.zoomX) && isNaN(a.zoomY) ? (c.showDescriptionAndGetUrl(), b || c.processObjects()) : (c.selectedObjectTimeOut = setTimeout(function() {
            ...
            if (d = a.groupId)
                for (k = a.groupArray, k || (k = c.getGroupById(d), a.groupArray = k), n = 0; n < k.length; n++) {
                    ...
                    d = m.displayObject;
                    "MapImage" ==
                    m.objectType && (d = m.image);
                    if (d) {
                        var r = m.selectedColorReal;
                        void 0 !== r && d.setAttr("fill", r);
                        void 0 !== g && d.setAttr("stroke", g);
                        void 0 !== h && d.setAttr("stroke-width", h);
                        "MapLine" == m.objectType && ((d = m.lineSvg) && d.setAttr("stroke", l), d = m.arrowSvg) && (d.setAttr("fill", l), d.setAttr("stroke", l))
                    }
                }
        ...
        zoomToObject: function(a) {
            if (a) {
                ...
                isNaN(d) || (isNaN(b) || isNaN(c) ?
                    this.zoomTo(d, l, g, f) : this.zoomToLongLat(d, c, b, f));
                ...
                "MapArea" == a.objectType && (l = a.displayObject.getBBox(), b = this.mapScale, c = l.x * b, d = l.y * b, f = l.width * b, l = l.height * b, h = a.autoZoomReal && isNaN(a.zoomLevel) ? f / h > l / k ? .8 * h / f : .8 * k / l : a.zoomLevel, k = this.zoomControl, h = e.fitToBounds(h, k.minZoomLevel,
                    k.maxZoomLevel), isNaN(a.zoomX) && isNaN(a.zoomY) && isNaN(a.zoomLatitude) && isNaN(a.zoomLongitude) && (a = this.mapSet.getBBox(), this.zoomToMapXY(h, -a.x * b + c + f / 2, -a.y * b + d + l / 2)));
        ...
        showAsRolledOver: function(a) {
            ...
            if (!a.showAsSelected && b && !a.isOver) {
                ...
                "MapImage" == a.objectType ? (c = this.imagesSettings.rollOverOutlineThickness, (d = a.image) && (isNaN(c) || d.setAttr("stroke-width", c))) : (c = this.areasSettings.rollOverOutlineThickness,
                ...
                "MapImage" == a.objectType && (c = a.rollOverScaleReal, isNaN(c) || 1 == c || (d = b.scale, isNaN(d) && (d =
        ...
        rollOverMapObject: function(a, b, c) {
            if (this.chartCreated) {
                ...
                if (!this.preventHover) {
                    ...
                    this.showDescriptionOnHover ? this.showDescription(a) : !this.showBalloonOnSelectedObject && this.checkIfSelected(a) || !1 === b || (f = this.balloon, this.balloon.fixedPosition = !1, b = a.colorReal, d = "", void 0 !== b && this.useObjectColorForBalloon || (b = f.fillColor), (f = a.balloonTextReal) &&
                        (d = this.formatString(f, a)), this.balloonLabelFunction && (d = this.balloonLabelFunction(a, this)), "MapArea" != a.objectType && (this.balloonX = NaN), d && "" !== d && this.showBalloon(d, b, !1, this.balloonX, this.balloonY));
                    c = {
        ...
        coordinateToLatitude: function(a) {
            ...
            if (this.mapSet) {
                var c = this.dataProvider,
                    ...
                    f = c.topLatitude;
                b = this.mapHeight;
                "mercator" == c.projection ? (c = this.mercatorLatitudeToCoordinate(d), f = this.mercatorLatitudeToCoordinate(f), a = 2 * Math.atan(Math.exp(2 * (a * (c - f) / b + f) * Math.PI / 180)) - .5 * Math.PI, b = e.radiansToDegrees(a)) : b = a / b * (d - f) + f
            }
                ...
                for (f = 0; f < h; f++) {
                    ...
                    if (0 !== e.childNodes.length || "" !== n || !1 !== m)
                        if (3 == e.nodeType || 4 == e.nodeType) {
                            if ("" !== n) {
                                e = 0;
                                for (g in a[b]) a[b].hasOwnProperty(g) &&
                                    e++;
                                e ? a[b]["#text"] = n : a[b] = n
                            }
                        } else if (1 == e.nodeType) {
                        var r;
                        void 0 !== a[b][k] ? void 0 === a[b][k].length ? (r = a[b][k], a[b][k] = [], a[b][k].push(r), a[b][k].push({}), r = a[b][k][1]) : "object" == typeof a[b][k] && (a[b][k].push({}), r = a[b][k][a[b][k].length - 1]) : (a[b][k] = {}, r = a[b][k]);
        ...
        processObject: function(a, b, c) {
            if (a) {
                ...
                for (d = 0; d < a.length; d++) {
                    ...
                    f.lines && this.processObject(f.lines,
                        f, "line")
                }
            }
        },
...
(function() {
    ...
    e.ZoomControl = e.Class({
        ...
        init: function(a, b) {
            ...
            isNaN(c.bottom) || (v = a.getY(c.bottom, !0), l && (v -= p + 3 * f), v = g ? v - 3 * f : c.homeButtonEnabled ? v - .5 * f : v + f);
            d.translate(t, v);
            c.previousDY = NaN;
            var A, t = f / 4 - 1;
            if (l) {
                ...
                A.push(J);
                for (y = 1; y < H; y++) v = f + y * l, v = e.line(b, [1, z - 2], [v, v], c.gridColor, c.gridAlpha, 1), e.setCN(a, v, "zoom-grid"), J.push(v);
                ...
                c.previousY = NaN;
                v = new e.SimpleButton;
                F ? (z = b.set(), H = e.line(b, [-t, t], [0, 0], x, C, 1), y = e.line(b, [0, 0], [-t, t], x, C, 1), z.push(H), z.push(y), v.svgIcon = z) : v.setIcon(a.pathToImages + "plus.gif", c.iconSize);
            ...
            g && (g = b.set(), e.setCN(a, g, "zoom-control-pan"), d.push(g), A && A.translate(f, 4 * f), w = new e.SimpleButton, F ? w.svgIcon = e.line(b, [t / 5, -t + t / 5, t / 5], [-t, 0, t], x, C, 1) : w.setIcon(a.pathToImages +
                "panLeft.gif", c.iconSize), w.setClickHandler(a.moveLeft, a), w.init(b, f, f, h, k, n, m, r, u, q, C, x, D), w.set.translate(0, f), e.setCN(a, w.set, "pan-left"), g.push(w.set), w = new e.SimpleButton, F ? w.svgIcon = e.line(b, [-t / 5, t - t / 5, -t / 5], [-t, 0, t], x, C, 1) : w.setIcon(a.pathToImages + "panRight.gif", c.iconSize), w.setClickHandler(a.moveRight, a), w.init(b, f, f, h, k, n, m, r, u, q, C, x, D), w.set.translate(2 * f, f), e.setCN(a, w.set, "pan-right"), g.push(w.set), w = new e.SimpleButton, F ? w.svgIcon = e.line(b, [-t, 0, t], [t / 5, -t + t / 5, t / 5], x, C, 1) : w.setIcon(a.pathToImages +
                "panUp.gif", c.iconSize), w.setClickHandler(a.moveUp, a), w.init(b, f, f, h, k, n, m, r, u, q, C, x, D), w.set.translate(f, 0), e.setCN(a, w.set, "pan-up"), g.push(w.set), w = new e.SimpleButton, F ? w.svgIcon = e.line(b, [-t, 0, t], [-t / 5, t - t / 5, -t / 5], x, C, 1) : w.setIcon(a.pathToImages + "panDown.gif", c.iconSize), w.setClickHandler(a.moveDown, a), w.init(b, f, f, h, k, n, m, r, u, q, C, x, D), w.set.translate(f, 2 * f), e.setCN(a, w.set, "pan-down"), g.push(w.set), d.push(g));
            c.homeButtonEnabled && (g = new e.SimpleButton, F ? g.svgIcon = e.polygon(b, [-t, 0, t, t - 1, t - 1,
                2, 2, -2, -2, -t + 1, -t + 1
            ], [0, -t, 0, 0, t - 1, t - 1, 2, 2, t - 1, t - 1, 0], x, C, 1, x, C) : g.setIcon(a.pathToImages + c.homeIconFile, c.iconSize), g.setClickHandler(a.goHome, a), c.panControlEnabled && (r = k = 0), g.init(b, f, f, h, k, n, m, r, u, q, C, x, D), c.panControlEnabled ? g.set.translate(f, f) : A && A.translate(0, 1.5 * f), e.setCN(a, g.set, "pan-home"), d.push(g.set));
            c.update()
        },
        ...
        handleBgUp: function() {
            var a = this.chart,
                b = 100 * Math.pow(this.zoomFactor,
        ...
        update: function() {
            var a, b = this.zoomFactor,
                ...
                l = this.buttonSize,
                g = this.chart;
            g && (this.isDragging ? (g.stopDrag(), a = f.y + (g.mouseY - this.previousY), a = e.fitToBounds(a, l, this.realGridHeight + l), c = 100 * Math.pow(b, d - (a - l) / c), g.zoomTo(c, NaN, NaN, !0)) : (a = Math.log(g.zoomLevel() / 100) / Math.log(b), a = (d - a) * c + l), this.previousY = g.mouseY, this.previousDY != a &&
                f && (f.translate((this.buttonSize - this.draggerSize) / 2, a), this.previousDY = a))
        }
    })
})();
(function() {
        ...
        init: function(a, b) {
            ...
            if (c.enabled) {
                ...
                var k, n, h = c.minimizeButtonWidth,
                    ...
                    r = h / 2;
                a.svgIcons ? m.svgIcon = e.line(b, [-r / 2, 0, r / 2], [-r / 4, r / 4, -r / 4], c.iconColor, 1, 1) : m.setIcon(a.pathToImages +
                    "arrowDown.gif", h);
    ...
    e.AreasProcessor = e.Class({
        ...
        updateAllAreas: function() {
            ...
            for (m = 0; m < g.length; m++) {
                ...
                if (b.preserveOriginalAttributes) {
                    if (k.customAttr)
                        for (var r in k.customAttr) k.setAttr(r,
                            k.customAttr[r])
                } else {
                ...
                h.getAreasFromMap && !n[k.id] && (u = new e.MapArea(a.theme), u.parentObject = h, u.id = k.id, h.areas.push(u))
            }
        },
        createArea: function(a) {
            ...
            if (c && (r = c.area, C = c.title, a.enTitle = c.title, C && !a.title && (a.title = C), (c = b.language) ? (C = e.mapTranslations) && (c = C[c]) && c[a.enTitle] && (a.titleTr = c[a.enTitle]) : a.titleTr = void 0, r)) {
                ...
                a.preserveOriginalAttributes || (r.setAttr("fill", F), r.setAttr("stroke", l), r.setAttr("stroke-opacity", u), r.setAttr("stroke-width", q), r.setAttr("fill-opacity", D));
    ...
    e.ImagesProcessor = e.Class({
        ...
        createImage: function(a, b) {
            ...
            if (B) {
                isNaN(A) && (A = 10);
                isNaN(p) && (p = 10);
                "kilometers" == a.widthAndHeightUnits && (A = c.kilometersToPixels(a.width), p = c.kilometersToPixels(a.height));
                "miles" == a.widthAndHeightUnits && (A = c.milesToPixels(a.width), p = c.milesToPixels(a.height));
                if ("circle" == B || "bubble" ==
                    B) p = A;
                y = this.createPredefinedImage(H, u, q, B, A, p);
                t = v = 0;
                a.centeredReal ? (isNaN(a.right) || (v = A * m), isNaN(a.bottom) || (t = p * m)) : (v = A * m / 2, t = p * m / 2);
                y.translate(v, t, m, !0)
            } else E ? (isNaN(A) && (A = 10), isNaN(p) && (p = 10), y = d.image(E, 0, 0, A, p), y.node.setAttribute("preserveAspectRatio", "none"), y.setAttr("opacity", h), a.centeredReal && (v = isNaN(a.right) ? -A / 2 : A / 2, t = isNaN(a.bottom) ? -p / 2 : p / 2, y.translate(v, t, NaN, !0))) : D && (y = d.path(D), u = y.getBBox(), a.centeredReal ? (v = -u.x * m - u.width * m / 2, isNaN(a.right) || (v = -v), t = -u.y * m - u.height * m /
                2, isNaN(a.bottom) || (t = -t)) : v = t = 0, y.translate(v, t, m, !0), y.x = v, y.y = t);
            y && (z.push(y), a.image = y, y.setAttr("stroke-opacity", k), y.setAttr("fill-opacity", h), y.setAttr("fill", H), e.setCN(c, y, "map-image"), void 0 != a.id && e.setCN(c, y, "map-image-" + a.id));
            H = a.labelColorReal;
            !a.showAsSelected && c.selectedObject != a || void 0 == g || (y.setAttr("fill", g), H = a.selectedLabelColorReal);
            y = null;
            void 0 !== a.label && (y = e.text(d, a.label, H, c.fontFamily, a.labelFontSizeReal, a.labelAlign), e.setCN(c, y, "map-image-label"), void 0 !== a.id && e.setCN(c,
                y, "map-image-label-" + a.id), H = a.labelBackgroundAlpha, (h = a.labelBackgroundColor) && 0 < H && (k = y.getBBox(), d = e.rect(d, k.width + 16, k.height + 10, h, H), e.setCN(c, d, "map-image-label-background"), void 0 != a.id && e.setCN(c, d, "map-image-label-background-" + a.id), z.push(d), a.labelBG = d), a.imageLabel = y, z.push(y), e.setCN(c, z, "map-image-container"), void 0 != a.id && e.setCN(c, z, "map-image-container-" + a.id));
            d = isNaN(a.latitude) || isNaN(a.longitude) ? !0 : !1;
            a.lineId && (y = this.chart.getObjectById(a.lineId)) && 0 < y.longitudes.length &&
                (d = !1);
            d ? l.push(z) : f.push(z);
        ...
        updateSizeAndPosition: function(a) {
            ...
            isNaN(a.bottom) || (f = b.getY(a.bottom, !0) - g.height *
                a.scale);
            var h = a.longitude,
                k = a.latitude,
                n = a.positionOnLine,
            ...
            if (a.lineId) {
                ...
                (a.line = u) && u.getCoordinates && (u.chart = b, u = u.getCoordinates(n, a.lineSegment)) && (h = b.coordinateToLongitude(u.x), k = b.coordinateToLatitude(u.y), l = e.radiansToDegrees(u.angle))
            }
            isNaN(l) || c.rotate(l +
                a.extraAngle);
        ...
        positionLabel: function(a, b, c) {
            if (a) {
                ...
                b.labelBG && b.labelBG.translate(f - d.width / 2 + b.labelShiftX - 9, e + b.labelShiftY - d.height /
                    2 - 3, NaN, !0)
            }
        },
        ...
        createLine: function(a, b) {
            ...
            if (a.remainVisible || c.selectedObject == a.parentObject) {
                ...
                p =
                    m.length;
                if (0 < p)
                    for (x = [], B = 0; B < p; B++) x.push(c.longitudeToCoordinate(m[B]));
                p = d.length;
                if (0 < p)
                    for (F = [], B = 0; B < p; B++) F.push(c.latitudeToCoordinate(d[B]));
                if (0 < x.length) {
                    a.segments = x.length;
                    e.dx = 0;
                    e.dy = 0;
                    ...
                    a.distances = [];
                    if (isNaN(m)) {
                        for (m = 0; m < x.length - 1; m++) H = F[m], p = F[m + 1], H = Math.sqrt(Math.pow(x[m + 1] - x[m], 2) + Math.pow(p - H, 2)), a.distances[m] = H;
                    ...
                    if ("none" != D) {
                        var G, I, K;
                        if ("end" == D || "both" == D) q = x[x.length - 1], p = F[F.length - 1], 1 < x.length ? (h = x[x.length - 2], G = F[F.length - 2]) : (h = q, G = p), G = 180 * Math.atan((p - G) / (q - h)) / Math.PI, isNaN(z) || (G += z), I = q, K = p, G = 0 > q - h ? G - 90 : G + 90;
                        "both" == D && (q = e.polygon(t, [-u / 2, 0, u / 2], [1.5 * u, 0, 1.5 * u], n, r, 1, n, r), v.push(q), q.translate(I, K, 1, !0), isNaN(G) || q.rotate(G), e.setCN(c,
                            m, "map-line-arrow"), void 0 != a.id && e.setCN(c, m, "map-line-arrow-" + a.id), a.fixedSize && f.push(q));
                        if ("start" == D || "both" == D) q = x[0], K = F[0], 1 < x.length ? (h = x[1], I = F[1]) : (h = q, I = K), G = 180 * Math.atan((K - I) / (q - h)) / Math.PI, isNaN(z) || (G -= z), I = q, G = 0 > q - h ? G - 90 : G + 90;
                        "middle" == D && (q = x[x.length - 1], p = F[F.length - 1], 1 < x.length ? (h = x[x.length - 2], G = F[F.length - 2]) : (h = q, G = p), I = h + (q - h) / 2, K = G + (p - G) / 2, G = 180 * Math.atan((p - G) / (q - h)) / Math.PI, isNaN(z) || (z = H / 2, y -= Math.sqrt(y * y - z * z), 0 > C && (y = -y), z = Math.sin(G / 180 * Math.PI), -1 == z && (z = 1), I -=
        ...
        getCoordinates: function(a, b) {
            ...
            if (!isNaN(a)) {
                ...
                1 < this.longitudes.length ?
                    (c = this.chart.longitudeToCoordinate(this.longitudes[b]), f = this.chart.longitudeToCoordinate(this.longitudes[b + 1]), d = this.chart.latitudeToCoordinate(this.latitudes[b]), l = this.chart.latitudeToCoordinate(this.latitudes[b + 1])) : 1 < this.x.length && (c = this.x[b], f = this.x[b + 1], d = this.y[b], l = this.y[b + 1]);
    ...
    e.ValueLegend = e.Class({
        ...
        init: function(a, b) {
            if (this.enabled) {
                ...
                void 0 !== h && (g = e.text(b, h, m, n, k, "left"), g.translate(0, k / 2 - 1), e.setCN(a, g, "value-legend-min-label"), l.push(g), g = g.getBBox().height);
                h = this.maxValue;
                void 0 === h && (h = a.maxValueReal);
                void 0 !== h && (g = e.text(b, h, m, n, k, "right"), g.translate(this.width, k / 2 - 1), e.setCN(a, g, "value-legend-max-label"), l.push(g), g = g.getBBox().height);
                if (this.showAsGradient) c = e.rect(b, this.width, this.height, [c, d], 1, this.borderThickness, this.borderColor, 1, 0, 0), e.setCN(a, c, "value-legend-gradient"), c.translate(0, g), l.push(c);
                else
                    for (k = this.width / f, n = 0; n < f; n++) m = e.getColorFade(c, d, 1 * n / (f - 1)), m = e.rect(b, k, this.height, m, 1, this.borderThickness, this.borderColor, 1), e.setCN(a, m, "value-legend-color"), e.setCN(a, m, "value-legend-color-" + n), m.translate(k * n, g), l.push(m);
                d = c = 0;
                f = l.getBBox();
...
(function() {
    ...
    e.ObjectList = e.Class({
        ...
        addObjects: function(a, b) {
            ...
            if (a.images)
                for (e = 0; e < a.images.length; e++) l = a.images[e], void 0 === l.showInList && (l.showInList = c.showImagesInList), this.addObject(l, d);
            if (a.lines)
                for (e = 0; e < a.lines.length; e++) l = a.lines[e], void 0 === l.showInList && (l.showInList = c.showLinesInList), this.addObject(l, d);
        ...
        addObject: function(a, b) {
            ...
            if (a.showInList && void 0 !==
                ...
                var l = document.createTextNode(a.title),
