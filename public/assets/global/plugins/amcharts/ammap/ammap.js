                ...
                for (e = 0; e < b.length; e++) {
                    ...
                    if (!1 !== g.enabled) {
                        ...
                        var k = this.marginLeft,
                            f = d.wrappedText(this.container, g.text, f, this.fontFamily, h, "middle", !1, this.divRealWidth - 20);
            ...
            if (!isNaN(a)) {
                ...
                if (this.show) {
                    ...
                    0 < this.animationDuration && !e && !isNaN(this.prevX) && (f.translate(this.prevX, this.prevY), f.animate({
                        translate: u - g + "," +
                            x
                    }, b, "easeOutSine"), n && (D.left = this.prevTX + "px", D.top = this.prevTY + "px", this.xAnim = c.animate({
                        node: n
...
(function() {
    ...
    d.bullet = function(a, b, c, e, g, f, h, k, l, m, n, r) {
        ...
        switch (b) {
            ...
            case "rectangle":
                t = d.polygon(a, [-c,
                    c, c, -c
                ], [c / 2, c / 2, -c / 2, -c / 2], e, g, f, h, k, m - 180);
                break;
            case "diamond":
    ...
    d.makeHD = function(a, b, c) {
        for (var e = [], d = [], f = 1; f < a.length; f++)
            for (var h = Number(a[f - 1]), k = Number(b[f - 1]), l = Number(a[f]), m = Number(b[f]), n = Math.sqrt(Math.pow(l - h, 2) + Math.pow(m - k, 2)), n = Math.round(n / 50) + 1, l = (l - h) / n, m = (m - k) / n, r = 0; r <= n; r++) {
                var t = h + r * l + Math.random() * c,
                    p = k + r * m + Math.random() * c;
                e.push(t);
                d.push(p)
            }
        return [e, d]
    ...
    d.handDrawnLine = function(a, b, c, e, g, f, h, k, l, m) {
        ...
        for (n = 1; n < b.length; n++)
            for (var t = [b[n - 1], b[n]], p = [c[n - 1], c[n]], p = d.makeHD(t, p, a.handDrawScatter), t = p[0], p = p[1], q = 1; q < t.length; q++) r.push(d.line(a, [t[q - 1], t[q]], [p[q - 1], p[q]], e, g, f + Math.random() * a.handDrawThickness - a.handDrawThickness / 2, h, k, l, m, !0));
        return r
    };
            ...
            if (!1 !== a.visibleInLegend) {
                ...
                if (this.useGraphSettings) {
                    ...
                    if ("line" == c || "step" == c || "smoothedLine" == c || "ohlc" == c) h = l.set(), a.hidden || (e = a.lineColorR, f = a.bulletBorderColorR), n = d.line(l, [0, 2 * m], [m / 2, m / 2], e, a.lineAlpha, a.lineThickness, a.dashLength), d.setCN(b, n, "graph-stroke"), h.push(n), a.bullet && (a.hidden || (e = a.bulletColorR),
                        n = d.bullet(l, a.bullet, a.bulletSize, e, a.bulletAlpha, a.bulletBorderThickness, f, a.bulletBorderAlpha)) && (d.setCN(b, n, "graph-bullet"), n.translate(m + 1, m / 2), h.push(n)), t = 0, n = m, r = m / 3;
                    else {
                        var p;
        ...
        handleMouseMove: function(a) {
            ...
            if (!a || !a.touches || !b.tapToActivate || b.tapped) {
                ...
                if (a =
                    ...
                    if (!isNaN(k)) {
                        b.stopDrag();
                        var p = Math.sqrt(Math.pow(k - g, 2) + Math.pow(l - f, 2)),
                            q = b.initialDistance;
                ...
                for (g = 0; g < k; g++) {
                    ...
                    if (0 !== f.childNodes.length || "" !== m || !1 !== n)
                        ...
                        if (f.attributes && f.attributes.length)
                            for (m = 0; m < f.attributes.length; m++) r[f.attributes[m].name] = f.attributes[m].value;
    ...
    d.ZoomControl = d.Class({
        ...
        init: function(a, b) {
            ...
            c.homeButtonEnabled && (h = new d.SimpleButton, D ? h.svgIcon = d.polygon(b, [-u, 0, u, u - 1, u - 1,
                2, 2, -2, -2, -u + 1, -u + 1
            ], [0, -u, 0, 0, u - 1, u - 1, 2, 2, u - 1, u - 1, 0], w, A, 1, w, A) : h.setIcon(a.pathToImages + c.homeIconFile, c.iconSize), h.setClickHandler(a.goHome, a), c.panControlEnabled && (r = l = 0), h.init(b, g, g, k, l, m, n, r, t, p, A, w, x), c.panControlEnabled ? h.set.translate(g, g) : F && F.translate(0, 1.5 * g), d.setCN(a, h.set, "pan-home"), e.push(h.set));
            c.update()
        },
        ...
        createLine: function(a, b) {
            ...
            if (a.remainVisible || c.selectedObject == a.parentObject) {
                ...
                q =
                    n.length;
                if (0 < q)
                    for (w = [], C = 0; C < q; C++) w.push(c.longitudeToCoordinate(n[C]));
                q = e.length;
                if (0 < q)
                    for (D = [], C = 0; C < q; C++) D.push(c.latitudeToCoordinate(e[C]));
                if (0 < w.length) {
                    a.segments = w.length;
                    d.dx = 0;
                    d.dy = 0;
                    ...
                    if ("none" != x) {
                        ...
                        p.translate(K, L, 1, !0);
                        isNaN(H) || p.rotate(H);
                        a.fixedSize && (g.push(p), a.arrays.push({
                            arr: g,
                            el: p
                        }));
                        a.arrowSvg = p
