(function() {
    ...
    c.AmRadarChart = c.Class({
        ...
        formatString: function(a, b, d) {
            var f = b.graph; - 1 != a.indexOf("[[category]]") &&
                (a = a.replace(/\[\[category\]\]/g, String(b.serialDataItem.category)));
            f = f.numberFormatter;
            f || (f = this.nf);
            a = c.formatValue(a, b.values, ["value"], f, "", this.usePrefixes, this.prefixesOfSmallNumbers, this.prefixesOfBigNumbers); - 1 != a.indexOf("[[") && (a = c.formatDataContextValue(a, b.dataContext));
        ...
        construct: function(a) {
            ...
            if (b) {
                ...
                var u = b.chartData,
                    A = u.length,
                    w, n = this.axisWidth;
                "middle" == a.pointPosition && "circles" != a.gridType && (a.rMultiplier =
                ...
                for (w = 0; w < A; w++) {
                    ...
                    0 < k && (v = c.line(b.container, [l, v], [e, t], f, k, d), this.set.push(v), c.setCN(b, v, a.bcn + "line"));
                    if (g) {
                        var B = "start",
                        ...
                        180 == q && (t -= 5);
                        0 === q && (t += 5);
                        q = c.text(b.container, u[w].category,
                            r, h, m, B);
                        q.translate(v + 5, t);
                        this.set.push(q);
...
(function() {
    ...
    c.RadItem = c.Class({
        construct: function(a, b, d, f, k, l, e, p) {
            ...
            var z, D = a.x,
                J = a.y;
            e ? (G = !0, void 0 !== e.id && (C = f.classNamePrefix + "-guide-" + e.id), isNaN(e.tickLength) || (w = e.tickLength), void 0 != e.lineColor && (q = e.lineColor), isNaN(e.lineAlpha) || (n = e.lineAlpha), isNaN(e.dashLength) || (v = e.dashLength), isNaN(e.lineThickness) || (t = e.lineThickness), !0 === e.inside && (H = !0), void 0 !== e.boldLabel && (p = e.boldLabel)) : d || (n /= 3, w /= 2);
            var K = "end",
                F = -1;
            H && (K = "start", F = 1);
            var y;
            G && (y = c.text(r, d, m, g, h, K, p), y.translate(D + (w + 3 + L) * F, b), k.push(y), c.setCN(f, y, a.bcn + "label"), e && c.setCN(f, y, "guide"),
                c.setCN(f, y, C, !0), this.label = y, z = c.line(r, [D, D + w * F], [b, b], u, A, t), k.push(z), c.setCN(f, z, a.bcn + "tick"), e && c.setCN(f, z, "guide"), c.setCN(f, z, C, !0));
            b = Math.round(a.y - b);
            p = [];
            g = [];
            if (0 < n) {
                if ("polygons" == I) {
                    x = a.data.length;
                    for (h = 0; h < x; h++) m = 180 - 360 / x * h, p.push(b * Math.sin(m / 180 * Math.PI)), g.push(b * Math.cos(m / 180 * Math.PI));
                    p.push(p[0]);
                    g.push(g[0]);
            ...
            if (1 ==
                ...
                e = a.previousCoord;
                if ("polygons" == I) {
                    for (h = x; 0 <= h; h--) m = 180 - 360 / x * h, p.push(e * Math.sin(m / 180 * Math.PI)), g.push(e * Math.cos(m / 180 * Math.PI));
                    x = c.polygon(r, p, g, B, E)
                } else x = c.wedge(r, 0, 0, 0, 360, b, b, e, 0, {
                    fill: B,
                    "fill-opacity": E,
                    stroke: "#000",
                    "stroke-opacity": 0,
        ...
        construct: function(a, b, d, f) {
            ...
            if ("polygons" == a.gridType) {
                var h = [],
                    ...
                    r = a.data.length,
                    u;
                for (u = 0; u < r; u++) g = 180 - 360 / r * u, h.push(k *
                    Math.sin(g / 180 * Math.PI)), m.push(k * Math.cos(g / 180 * Math.PI));
                h.push(h[0]);
                m.push(m[0]);
                for (u = r; 0 <= u; u--) g = 180 - 360 / r * u, h.push(b * Math.sin(g / 180 * Math.PI)), m.push(b * Math.cos(g / 180 * Math.PI));
                l = c.polygon(l, h, m, p, e)
            } else l = c.wedge(l, 0, 0, g, h - g, k, k, b, 0, {
                fill: p,
                "fill-opacity": e,
                stroke: "#000",
                "stroke-opacity": 0,
