    ...
    e.AmSerialChart = e.Class({
        ...
        countColumns: function() {
            ...
            for (k = 0; k < b; k++) {
                ...
                var m = e.stackType;
                if ("100%" == m || "regular" == m)
                    for (h = !1, g = 0; g < c; g++) d = this.graphs[g], d.tcc = 1, d.valueAxis == e && "column" == d.type && (!h && d.stackable && (a++, h = !0), (!d.stackable && d.clustered || d.newStack) && a++, d.columnIndex = a - 1, d.clustered || (d.columnIndex = 0));
                if ("none" == m || "3d" == m) {
                    h = !1;
                ...
                if ("3d" == m) {
                    e = 1;
                    for (k = 0; k < c; k++) d = this.graphs[k], d.newStack && e++, d.depthCount =
                        e, d.tcc = a;
                    a = e
                }
            }
        ...
        formatString: function(a,
            ...
            if (-1 != a.indexOf("[[category]]")) {
                ...
                if (this.categoryAxis.parseDates) {
                    var h = this.balloonDateFormat,
                        g = this.chartCursor;
                    g && (h = g.categoryBalloonDateFormat); - 1 != a.indexOf("[[category]]") && (h = e.formatDate(f, h, this), -1 != h.indexOf("fff") && (h = e.formatMilliseconds(h, f)), f = h)
                }
            ...
            f || (f = this.nf);
            h = b.graph.valueAxis;
            (g = h.duration) && !isNaN(b.values.value) && (g = e.formatDuration(b.values.value, g, "", h.durationUnits,
                h.maxInterval, f), a = a.replace(RegExp("\\[\\[value\\]\\]", "g"), g));
...
(function() {
    ...
    e.Cuboid = e.Class({
        ...
        draw: function() {
            ...
            d = isNaN(r) ? 0 > f ? [u,
                M, B, C, I, z, D, F, L, b
            ] : [F, L, B, C, I, z, u, M, D, b] : K ? 0 < d ? [u, b, F] : [F, b, u] : 0 > f ? [u, b, F] : [F, b, u];
            e.setCN(c, b, t + "front");
            e.setCN(c, B, t + "back");
            e.setCN(c, F, t + "top");
            ...
            for (u = 0; u < d.length; u++)
                if (B = d[u]) a.push(B), e.setCN(c, B, t + "element");
        ...
        draw: function() {
            ...
            if (e.ifArray(a)) {
                ...
                if (this.parseDates && !this.equalSpacing) this.lastTime = a[a.length -
                    1].time, this.maxTime = e.resetDateToMin(new Date(this.lastTime + 1.05 * x), this.minPeriod, 1, p).getTime(), this.timeDifference = this.endTime - this.startTime, this.parseDatesDraw();
                else if (!this.parseDates) {
                    if (this.cellWidth = this.getStepWidth(g), g < k && (k = g), h += this.start, this.stepWidth = this.getStepWidth(g), 0 < k)
                        for (k = Math.floor(g / k), g = this.chooseMinorFrequency(k), n = h, n / 2 == Math.round(n / 2) && n--, 0 > n && (n = 0), a = 0, this.end - n + 1 >= this.autoRotateCount && (this.labelRotationR = this.autoRotateAngle), b = n; b <= this.end + 2; b++) {
                            q = !1;
                            0 <= b && b < this.data.length ? (w = this.data[b], n = w.category, q = w.forceShow) : n = "";
                            if (t && !isNaN(g))
                                if (b / g == Math.round(b / g) || q) b / k == Math.round(b / k) || q || (this.gridAlpha = this.minorGridAlpha, n = void 0);
                                else continue;
                    ...
                    if (this.data[n].time != e.resetDateToMin(new Date(this.data[n].time), f, y, p).getTime())
                        for (p = 0, v = x, b = n; b < A; b++) g = this.data[b].time, this.checkPeriodChange(f, y, g, v) && (p++, 2 <= p && (a = b, b = A), v = g);
                    t && 1 < y && (g = this.chooseMinorFrequency(y),
                ...
                for (b = 0; b < this.data.length; b++)
                    if (v = this.data[b]) m = this.parseDates && !this.equalSpacing ? Math.round((v.time - this.startTime) * this.stepWidth + this.cellWidth / 2) : this.getCoordinate(b - h), isNaN(v.widthValue) || (v.percentWidthValue = v.widthValue /
