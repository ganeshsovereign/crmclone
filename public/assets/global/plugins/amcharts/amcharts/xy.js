(function() {
    ...
    e.AmXYChart = e.Class({
        ...
        drawChart: function() {
            ...
            e.ifArray(this.chartData) ? (this.chartScrollbar &&
                this.updateScrollbars(), this.selfZoom && (this.horizontalPosition = this.horizontalPosition * this.plotAreaWidth / this.prevPlotAreaWidth, this.verticalPosition = this.verticalPosition * this.plotAreaHeight / this.prevPlotAreaHeight, this.selfZoom = !1), this.zoomChart()) : this.cleanChart();
        ...
        formatString: function(a, c, b) {
            ...
            a = e.formatValue(a, c.values, ["value", "x", "y"], f); - 1 != a.indexOf("[[") && (a = e.formatDataContextValue(a,
                c.dataContext));
        ...
        handleReleaseOutside: function(a) {
            ...
            e.callMethod("handleReleaseOutside", [this.scrollbarH,
                this.scrollbarV
            ])
        },
        update: function() {
