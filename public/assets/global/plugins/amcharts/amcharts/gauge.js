(function() {
    ...
    c.GaugeAxis = c.Class({
            ...
            if (t)
                for (var q = 0; q < t.length; q++) {
                    ...
                    if (l) {
                        var x = l.startValue,
                            B = l.endValue,
                            m = c.toCoordinate(l.radius, y);
                        isNaN(m) && (m = F);
                        var u = c.toCoordinate(l.innerRadius, y);
                        isNaN(u) && (u = m - H);
                        var J = v + f * (x - this.startValue),
                            B = f * (B - x),
                            A = l.outlineColor;
        ...
        addListeners: function(a, b) {
            var c = this;
            b.mouseover(function(a) {}).mouseout(function(b) {
                c.fireEvent("rollOutBand", a, b)
            }).touchend(function(b) {
                c.fireEvent("clickBand",
                    a, b)
            }).touchstart(function(b) {
                c.fireEvent("rollOverBand", a, b)
            }).click(function(b) {
                c.fireEvent("clickBand", a, b)
            })
        },
...
(function() {
    ...
    c.AmAngularGauge = c.Class({
        ...
        formatString: function(a, b) {
            return a = c.formatValue(a, b, ["value"], this.nf, "", this.usePrefixes, this.prefixesOfSmallNumbers, this.prefixesOfBigNumbers)
        },
        initChart: function() {
            ...
            var b;
            for (b = 0; b < this.axes.length; b++) a = this.axes[b], a = c.processObject(a, c.GaugeAxis, this.theme), a.id || (a.id =
            ...
            this.drawChart();
            this.totalFrames = 1E3 * this.startDuration /
                c.updateRate
        },
        drawChart: function() {
            ...
            this.centerY = (e - v - k) / 2 + v + this.extraHeight /
                2;
            isNaN(this.gaugeX) || (this.centerX = this.gaugeX);
            isNaN(this.gaugeY) || (this.centerY = this.gaugeY);
            var b = this.faceAlpha,
                e = this.faceBorderAlpha,
                f;
            if (0 < b || 0 < e) f = c.circle(a, h, this.faceColor, b, this.faceBorderWidth, this.faceBorderColor, e, !1), f.translate(this.centerX, this.centerY), f.toBack(), (a = this.facePattern) && f.pattern(a, NaN, this.path);
            for (b = h = a = 0; b < this.axes.length; b++) e = this.axes[b], g = e.radius, e.radiusReal = c.toCoordinate(g, this.radiusReal), e.draw(), n = 1, -1 !== String(g).indexOf("%") && (n = 1 + (100 - Number(g.substr(0,
                g.length - 1))) / 100), e.width * n > a && (a = e.width * n), e.height * n > h && (h = e.height * n);
        ...
        drawArrow: function(a, b) {
            ...
            if (!a.hidden) {
                ...
                var G = a.nailColor;
                G || (G = a.color);
                0 < a.nailRadius && (p = c.circle(e, a.nailRadius, p, a.nailAlpha, a.nailBorderThickness, p, a.nailBorderAlpha), c.setCN(this, p, "gauge-arrow-nail"), a.set.push(p), p.translate(n, v));
                ...
                var d = Math.sin(b / 180 * Math.PI),
                    ...
                    e = c.polygon(e, [n - k / 2 * p + w * d, n + f * d - h / 2 * p, n + f * d + h / 2 * p, n + k / 2 * p + w * d], [v + k / 2 * E - w * g, v - f * g + h / 2 * E,
                        v - f * g - h / 2 * E, v - k / 2 * E - w * g
                    ], a.color, a.alpha, 1, G, a.borderAlpha, void 0, !0);
        ...
        updateAnimations: function() {
            ...
            for (var a = this.arrows.length, b, e = 0; e < a; e++)
                if (b = this.arrows[e], b.axis && b.axis.value2angle) {
                    var d;
                    b.frame >= this.totalFrames ? d = b.value : (b.frame++, b.clockWiseOnly && b.value < b.previousValue && (d = b.axis, b.previousValue -= d.endValue - d.startValue), d = c.getEffect(this.startEffect), d = c[d](0, b.frame, b.previousValue, b.value - b.previousValue, this.totalFrames), isNaN(d) && (d = b.value));
                    d = b.axis.value2angle(d);
                    b.drawnAngle != d && (this.drawArrow(b,
                        d), b.drawnAngle = d)
                }
        }
    })
