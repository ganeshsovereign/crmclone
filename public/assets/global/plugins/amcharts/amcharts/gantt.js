(function() {
    ...
    c.AmGanttChart = c.Class({
        ...
        processGanttData: function() {
            ...
            isNaN(a.minimum) || (a.minimumDate = c.changeDate(new Date(p), f, a.minimum, !0, !0));
            ...
            for (a = 0; a < x.length; a++) {
                ...
                if (v)
                    for (var g = 0; g < v.length; g++) {
                        ...
                        l[n] = b;
                        l[w] = h;
                        var q = "lineColor color alpha fillColors description bullet customBullet bulletSize bulletConfig url labelColor dashLength pattern gap className".split(" "),
                            k, r;
                        for (r in q) k = q[r] + "Field", (m = this.graph[k]) && void 0 !== d[m] && (l[m + "_" + a + "_" + g] = d[m]);
                        m = h;
                        if (z) {
                            k = c.getDate(d[E], t, f);
                            var A = c.getDate(d[F], t, f);
                            p && (isNaN(b) || (k = c.changeDate(new Date(p), f, b, !0, !0)), isNaN(h) || (A = c.changeDate(new Date(p), f, h, !0, !0)));
                            l[n] = k.getTime();
                            l[w] = A.getTime()
                        }
                        h = {};
