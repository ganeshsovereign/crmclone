...
var HighchartsAdapter = function() {
    function o(c) {
        ...
        function b(b, c) {
            var f = b.HCEvents,
                k, h, l, g;
            if (b.removeEventListener) k = a;
            else if (b.attachEvent) k = d;
            else return;
            c ? (h = {}, h[c] = !0) : h = f;
            for (g in h)
                if (f[g])
                    for (l = f[g].length; l--;) k(b, g, f[g][l])
        }
        ...
        init: function(c) {
            ...
            n.prototype = {
                update: function() {
                    ...
                    var d = this.elem,
                        b = d.element;
                    if (m[this.prop]) m[this.prop](this);
                    else a && b ? d.attr("d", c.step(a[0], a[1], this.now, this.toD)) : d.attr ? b && d.attr(this.prop, this.now) : (a = {}, a[this.prop] = this.now + this.unit, Highcharts.css(d, a));
                    this.options.step &&
...
(function(c) {
    ...
    r.funnel = c.extendClass(r.pie, {
        ...
        translate: function() {
            var a = function(b, a) {
                ...
                y = e - u,
                a = this.data,
                z, A, x = d.dataLabels.position === "left" ? 1 : 0,
                B, l, E, p, j, v, m;
    ...
    c.seriesTypes.pyramid = c.extendClass(c.seriesTypes.funnel, {
        type: "pyramid"
    })
})(Highcharts);
/*
...
(function(k) {
    ...
    l.prototype.callbacks.push(function(e) {
        function f() {
            var c = [];
            j(e.series, function(a) {
                var b = a.options.dataLabels,
                    d = a.dataLabelCollections || ["dataLabel"];
                (b.enabled || a._hasPointLabels) && !b.allowOverlap && a.visible && j(d, function(b) {
                    j(a.points, function(a) {
                        if (a[b]) a[b].labelrank = m(a.labelrank, a.shapeArgs && a.shapeArgs.height), c.push(a[b])
                    })
                })
            });
            e.hideOverlappingLabels(c)
        }
        f();
        n(e, "redraw", f)
    });
    l.prototype.hideOverlappingLabels = function(e) {
        var f =
            e.length,
            c, a, b, d, g, h, i;
        for (a = 0; a < f; a++)
            if (c = e[a]) c.oldOpacity = c.opacity, c.newOpacity = 1;
        e.sort(function(a, b) {
            return (b.labelrank || 0) - (a.labelrank || 0)
        });
        for (a = 0; a < f; a++) {
            b = e[a];
            for (c = a + 1; c < f; ++c)
                if (d = e[c], b && d && b.placed && d.placed && b.newOpacity !== 0 && d.newOpacity !== 0 && (g = b.alignAttr, h = d.alignAttr, i = 2 * (b.box ? 0 : b.padding), g = !(h.x > g.x + (b.width - i) || h.x + (d.width - i) < g.x || h.y > g.y + (b.height - i) || h.y + (d.height - i) < g.y)))(b.labelrank < d.labelrank ? b : d).newOpacity = 0
        }
        j(e, function(a) {
            var b, c;
            if (a) {
