    ...
    m(["translate", "generatePoints", "drawTracker", "drawPoints", "render"], function(a) {
        function b(b) {
            ...
            if ((this.processedXData || this.options.data).length < (this.options.boostThreshold || Number.MAX_VALUE) || d) {
                if (a === "render" && this.image) this.image.attr({
                    href: ""
                }), this.animate = null;
                b.call(this)
    ...
    g.extend(l.prototype, {
        ...
        hasExtremes: function(a) {
            var b = this.options,
                ...
                d = this.yAxis && this.yAxis.options;
        ...
        destroyGraphics: function() {
            ...
            for (d = 0; d < b.length; d += 1)
                if ((c = b[d]) && c.graphic) c.graphic = c.graphic.destroy();
        ...
        renderCanvas: function() {
            var a = this,
                ...
                z = {},
                t, W = !!a.sampling,
                A, B = b.marker && b.marker.radius,
                C = this.cvsDrawPoint,
                D = b.lineWidth ?
                this.cvsLineTo : !1,
                E = B <= 1 ? this.cvsMarkerSquare : this.cvsMarkerCircle,
                X = b.enableMouseTracking !== !1,
                F, j = b.threshold,
                n = i.getThreshold(j),
                G = typeof j === "number",
                H = n,
                Y = this.fill,
                I = a.pointArrayMap && a.pointArrayMap.join(",") === "low,high",
                J = !!b.stacking,
                Z = a.cropStart || 0,
                j = c.options.loading,
                $ = a.requireSorting,
                K, aa = b.connectNulls,
                L = !k,
                u, v, o, r, ba = a.fillOpacity ? (new P(a.color)).setOpacity(T(b.fillOpacity, 0.75)).get() : a.color,
                M = function() {
            ...
            x(J ? a.data : k || m, function(b) {
                ...
                if (I) L && (f = b.slice(1, 3)), e = f[0], f = f[1];
                else if (J) c = b.x, f = b.stackY, e = f - b.y;
                b = f === null;
                $ || (h = f >= U && f <= V);
                if (!b && c >= p && c <= q && h)
                    if (c = Math.round(d.toPixels(c, !0)), W) {
                        if (o === void 0 || c === t) {
                            I || (e = f);
