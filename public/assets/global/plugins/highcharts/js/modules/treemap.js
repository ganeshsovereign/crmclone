...
(function(h) {
    ...
    j.treemap = u(j.scatter, o({
        ...
        pointClass: u(h.Point, {
            setVisible: j.pie.prototype.pointClass.prototype.setVisible
        }),
        ...
        calculateChildrenAreas: function(a,
            ...
            var c = this,
                ...
                f = i(c[e && e.layoutAlgorithm] && e.layoutAlgorithm, d.layoutAlgorithm),
        ...
        alg_func_lowAspectRatio: function(a, b, c) {
            var d = [],
                ...
                h = 0,
                j = c.length - 1,
                i = new this.alg_func_group(b.height, b.width, b.direction, g);
            k(c, function(c) {
        ...
        pointAttribs: function(a, b) {
            ...
            if (a.node.level <= this.nodeMap[this.rootNode].level) c.fill = "none", c["stroke-width"] = 0;
            else if (a.node.isLeaf) {
        ...
        drawPoints: function() {
            ...
            k(b, function(c) {
                ...
                a[b] || (a[b] = a.chart.renderer.g(b).attr({
                    zIndex: 1E3 - c.node.levelDynamic
                }).add(a.group));
                c.group = a[b];
                c.pointAttr = {
                    "": a.pointAttribs(c),
                    hover: a.pointAttribs(c, "hover"),
                    select: {}
                }
            });
            ...
            a.options.allowDrillToNode && k(b, function(b) {
                var d;
                if (b.graphic) d = b.drillId = a.options.interactByLeaf ? a.drillToByLeaf(b) : a.drillToByGroup(b), b.graphic.css({
        ...
        showDrillUpButton: function(a) {
            ...
            this.drillUpButton ? this.drillUpButton.attr({
                text: a
            }).align() : (e = (d = c.theme) && d.states, this.drillUpButton =
