        ...
        if (0 < a)
            for (var b = 0; b < a; b++) {
                ...
                if (0 < e.pv[0]) {
                    var d = n(c);
                    if (d)
                        if (z(p[b].swfVersion) && !(e.wk && 312 > e.wk)) t(c, !0), f && (g.success = !0, g.ref = E(c), f(g));
    ...
    return {
        ...
        embedSWF: function(a, b, c, d, g, o, h, j, k, m) {
            ...
            e.w3 && !(e.wk && 312 > e.wk) && a && b && c && d && g ? (t(b, !1), L(function() {
                ...
                var e = {};
                if (k && typeof k === r)
                    for (var l in k) e[l] = k[l];
                e.data = a;
                e.width = c;
                e.height = d;
                l = {};
                if (j && typeof j === r)
                    for (var p in j) l[p] = j[p];
                if (h && typeof h === r)
                    for (var q in h) l.flashvars = typeof l.flashvars != i ? l.flashvars + ("&" + q + "=" + h[q]) : q + "=" + h[q];
