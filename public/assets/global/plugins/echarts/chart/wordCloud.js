define("echarts/chart/wordCloud", ["require", "./base", "zrender/shape/Text", "../layout/WordCloud", "../component/grid", "../component/dataRange", "../config", "../util/ecData", "zrender/tool/util", "zrender/tool/color", "../chart"], function(e) {
    ...
    return t.prototype = {
        ...
        _cloudSprite: function(e, t, i) {
            if (!e.sprite) {
                ...
                for (--i; ++i < V;) {
                    ...
                    var d = o.measureText(e.text + "m").width * r,
                        U = e.size << 1;
                    if (e.rotate) {
        ...
        _place: function(e, t, i) {
            ...
            for (var o, r, s, l = this.defaultOption.size, h = ([{
                    ...
                    x: l[0],
                    y: l[1]
                }], t.x), m = t.y, V = Math.sqrt(l[0] * l[0] + l[1] * l[1]), d = this.defaultOption.spiral(l), U = Math.random() < .5 ? 1 : -1, p = -U;
    ...
    return t.prototype = {
        ...
        _getItemGroupLocation: function() {
            ...
            var U, p = this.reformCssArray(this.dataRangeOption.padding),
                c = this.zr.getWidth();
