...
var societeSchema = new Schema({
    ...
    phone: { type: String, set: MODULE('utils').setPhone, default: null },
    fax: { type: String, set: MODULE('utils').setPhone, default: null },
    ...
    //public_notes: String,
    code_compta: { type: String, set: MODULE('utils').setAccount, trim: true },
    code_compta_fournisseur: { type: String, set: MODULE('utils').setAccount, trim: true },
    user_creat: String,
    user_modif: String,
