...
*/
    ...
    createAllBills: function() {
        ...
        OrderModel.aggregate([
                ...
                {
                    "$project": { _id: 1, datec: 1, date_livraison: 1, entity: 1, "ref": 1, discount: 1, shipping: 1, total_paid: 1, "supplier": 1 }
                }, {
                    $lookup: {
                        from: 'Customers',
                        localField: 'supplier',
                ...
                { "$project": { _id: 1, datec: 1, date_livraison: 1, entity: 1, ref: 1, discount: 1, shipping: 1, ref: 1, "supplier": { $cond: { if: "$supplier.salesPurchases.cptBilling", then: "$supplier.salesPurchases.cptBilling", else: "$supplier._id" } } } },
                {
                    $lookup: {
                        from: 'orderRows',
                        localField: '_id',
